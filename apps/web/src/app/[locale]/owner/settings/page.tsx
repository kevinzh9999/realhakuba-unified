// apps/web/src/app/[locale]/owner/settings/page.tsx
'use client';
...
export default function OwnerSettingsPage() {
  ...
  // 这里需要获取当前登录的property name
  // 实际实现中可以从context或cookie中获取
  const [propertyName, setPropertyName] = useState('echo-villa'); // 临时硬编码
